...
def generate_detection_graph(time_range_hours, detection_log_path):
    ...
    # Determine bin width and timespan label based on the selected time range
    if time_range_hours <= 24:
        # For time ranges up to 24 hours, use 5-minute bins for finer granularity
